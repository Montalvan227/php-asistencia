        ...
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
               let estadoUsuario = objData.data.status == 1 ? 
                ...
                document.querySelector("#celApoderado").innerHTML = objData.data.apoderado;
    ...
    request.onreadystatechange = function(){
        ...
        if(request.readyState == 4 && request.status == 200){
            ...
            if(objData.status)
            {
                ...
                document.querySelector("#txtApoderado").value = objData.data.apoderado;
...
function fntDelUsuario(idpersona){
    swal({
        ...
        text: "¿Realmente quiere eliminar el Alumno?",
        icon: "warning",
		buttons: true,
		dangerMode: true,
    })
