                        ...
                        <div class="row">
                          <div class="col-md-7">
                            ...
                            <div class="row mb-3 nombreApellido">
                              ...
                              <div class="col-sm-4">
                                <input type="text" id="txtNombre" name ="txtNombre" class="form-control inputTexto" maxlength="50" />
                              </div>
                              <label class="col-sm-2 col-form-label" for="txtApellido">Apellidos</label>
                              <div class="col-sm-4">
                                <input type="text" id="txtApellido" name ="txtApellido" class="form-control inputTexto" maxlength="50" />
                              </div>
                            </div>
                            <div class="row mb-3">
                              <label class="col-sm-2 col-form-label" for="txtTelefono">Teléfono</label>
                              <div class="col-sm-10">
                                <input type="text" id="txtTelefono" name ="txtTelefono" class="form-control inputNumerico" pattern="[0-9]{9,11}" placeholder=""/>
                              </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                              <div class="col-sm-10">
                                <input type="hidden" id="txtApoderado" name ="txtApoderado" class="form-control inputTexto" maxlength="150"  placeholder="">
                              </div>
                            </div>
                          ...
                          <div class="col-md-5">
                            ...
                            <div class="row g-2 mb-3">
                              <div class="col-sm-2" style="line-height: 40px;">
                                <label for="listRolid" class="form-label">T. Usu.</label>
                              </div>
                              <div class="col-sm-10">
                            ...
                            <div class="row g-2 mb-3" style="visibility: hidden;">
                              <div class="col-sm-2" style="line-height: 40px;">
                                <label for="listGradoid" class="form-label">Grado</label>
                              </div>
                              <div class="col-sm-10">
                                <select id="listGradoid" type="" name="listGradoid" class="form-control listGradoid" style="width: 100%;" required>
