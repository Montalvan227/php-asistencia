                        ...
                        <div class="row">
                          <div class="col-md-7">
                            ...
                            <div class="row mb-3">
                              ...
                              <div class="col-sm-10">
                                <input type="text" id="txtTelefono" name ="txtTelefono" class="form-control" placeholder="" pattern="[0-9]{9,11}"/>
                              </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row g-2 mb-3">
                              ...
                              <div class="col-sm-10">
                                <select id="listRolid" name="listRolid" class="form-control listRolid" style="width: 100%;" required>
                                  <option value="5" selected>ALUMNO</option>
                                </select>
                              </div>
                            </div>
                            <div class="row g-2 mb-3">
                              ...
                              <div class="col-sm-10">
                                <select id="listGradoid" name="listGradoid" class="form-control listGradoid" style="width: 100%;" required>
