<?php
    ...
    function getSidebar(string $nameSidebar, $data){
        $view_sidebar = "Views/Template/Sidebar/{$nameSidebar}.php";
    ...
    function uploadImageProductos(array $data, string $name){
        $url_temps = $data['tmp_name'];
        $url_temp = resizepics($url_temps, '100', '70');
        $destino    = 'Assets/img/uploads/producto/'.$name;
    ...
    function uploadImageProducto(array $data, string $name){
        ...
        $url    = 'Assets/img/uploads/producto/'.$name;
        $move = move_uploaded_file($url_temp, $url);
        return $move;
    }

    function uploadImage(array $data, string $name, string $destino){
        $url_temp = $data['tmp_name'];
        $url    = $destino.$name;
        $move = move_uploaded_file($url_temp, $url);
        return $move;
    ...
    function deleteFile(string $name){
        unlink('Assets/img/uploads/producto/'.$name);
    }
